#welcome to my project fashion store
import os
import platform
import pymysql
import datetime

mydb=pymysql.connect(host="localhost",user="root",passwd="root",db="project")
...
def ViewPurchase():
        ...
        from product ,purchase  where product.product_id=purchase.item_id and product.PName=%s "
        itm=(item)
...
def SaleProduct():
        ...
        L.append(dt)
        tp=(L)
        sql="insert into sales (sales_id, item_id,no_of_items_sold,\
...
def ViewSales():
        ...
        sales.no_of_items_sold,sales.date_of_sale,sales.amount \
...
def MenuSet():
        ...
        print("* * * ******* Developed by: SRIVIDYA BUKKE : ****** * * * ")
        print("* * * ******** Guided by : SAVITA SHRAMA (PGT)COMUPTER SCIENCE ******* * * *")
        print("")
        print("*"*150)
        print("!"*150)
        print("*"*150)
